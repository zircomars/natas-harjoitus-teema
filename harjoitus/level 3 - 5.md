...
- Evästeet ovat pieniä tietoja, jotka tallentavat tietoja käyttäjästä tai tietokoneesta tunnistamista varten.
...
Ensimmäisenä kirjauduttaan ja otettaan jotakin talteen tällä komennolla;

```
┌──(kali㉿kali)-[~]
└─$ curl http://natas5.natas.labs.overthewire.org/ -u natas5 -c natas5_cookie.txt
Enter host password for user 'natas5':
<html>
<head>
<!-- This stuff in the header has nothing to do with the level -->
<link rel="stylesheet" type="text/css" href="http://natas.labs.overthewire.org/css/level.css">
...
┌──(kali㉿kali)-[~]
└─$ ls
custom_common.txt  Desktop  Documents  Downloads  Music  natas5_cookie.txt  Pictures  Public  sfa_cert.html  Templates  Videos
